...
def trendgetir(ulke="TR"):
    conn=sqlitecloud.connect('sqlitecloud://ck3f9etxhz.g4.sqlite.cloud:8860/chinook.sqlite?apikey=7Ke5IEslmaVtUFko7Lm3138Eob6dUUhpJJT0KiVObxE')
    c=conn.cursor()
...
def geminicevir(basliklar):
    ...
    client = genai.Client(api_key="AIzaSyCWa8jS3B4qXzvb25WEFVoayo1yA6oFhpE")
